...
/* SearchV1SearchGetOK describes a response with status code 200, with default header values.
...
func (o *SearchV1SearchGetOK) GetPayload() *models.FrameworkSearchSearchResultInterface {
	return o.Payload
}
...
/* SearchV1SearchGetDefault describes a response with status code -1, with default header values.
...
func (o *SearchV1SearchGetDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
