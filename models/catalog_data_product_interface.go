		...
		if m.MediaGalleryEntries[i] != nil {
			if err := m.MediaGalleryEntries[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("media_gallery_entries" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.ProductLinks[i] != nil {
			if err := m.ProductLinks[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("product_links" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.TierPrices[i] != nil {
			if err := m.TierPrices[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("tier_prices" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *CatalogDataProductInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateMediaGalleryEntries(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateProductLinks(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CatalogDataProductInterface) contextValidateCustomAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductInterface) contextValidateMediaGalleryEntries(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.MediaGalleryEntries); i++ {

		if m.MediaGalleryEntries[i] != nil {
			if err := m.MediaGalleryEntries[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("media_gallery_entries" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("media_gallery_entries" + "." + strconv.Itoa(i))
...
func (m *CatalogDataProductInterface) contextValidateOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductInterface) contextValidateProductLinks(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ProductLinks); i++ {

		if m.ProductLinks[i] != nil {
			if err := m.ProductLinks[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("product_links" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("product_links" + "." + strconv.Itoa(i))
...
func (m *CatalogDataProductInterface) contextValidateTierPrices(ctx context.Context, formats strfmt.Registry) error {
