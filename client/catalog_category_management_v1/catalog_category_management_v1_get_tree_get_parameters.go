...
func (o *CatalogCategoryManagementV1GetTreeGetParams) WithDefaults() *CatalogCategoryManagementV1GetTreeGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CatalogCategoryManagementV1GetTreeGetParams) SetDefaults() {
