...
func (m *CatalogDataProductAttributeInterface) validateAttributeCode(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateCustomAttributes(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateEntityTypeID(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateExtensionAttributes(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateFrontendInput(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateFrontendLabels(formats strfmt.Registry) error {
		...
		if m.FrontendLabels[i] != nil {
			if err := m.FrontendLabels[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("frontend_labels" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *CatalogDataProductAttributeInterface) validateIsRequired(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateOptions(formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) validateValidationRules(formats strfmt.Registry) error {
		...
		if m.ValidationRules[i] != nil {
			if err := m.ValidationRules[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("validation_rules" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *CatalogDataProductAttributeInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateFrontendLabels(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateValidationRules(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CatalogDataProductAttributeInterface) contextValidateCustomAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) contextValidateFrontendLabels(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.FrontendLabels); i++ {

		if m.FrontendLabels[i] != nil {
			if err := m.FrontendLabels[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("frontend_labels" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("frontend_labels" + "." + strconv.Itoa(i))
...
func (m *CatalogDataProductAttributeInterface) contextValidateOptions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductAttributeInterface) contextValidateValidationRules(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ValidationRules); i++ {

		if m.ValidationRules[i] != nil {
			if err := m.ValidationRules[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("validation_rules" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("validation_rules" + "." + strconv.Itoa(i))
...
func (m *CatalogDataProductAttributeInterface) UnmarshalBinary(b []byte) error {
	var res CatalogDataProductAttributeInterface
