...
/* CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostOK describes a response with status code 200, with default header values.
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostOK) GetPayload() int64 {
	return o.Payload
}
...
/* CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostBadRequest describes a response with status code 400, with default header values.
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
/* CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostDefault describes a response with status code -1, with default header values.
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
	...
	if o.BillingAddress != nil {
		if err := o.BillingAddress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostBody" + "." + "billingAddress")
			}
			return err
		}
	}
	...
	if o.PaymentMethod != nil {
		if err := o.PaymentMethod.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("checkoutGuestPaymentInformationManagementV1SavePaymentInformationPostBody" + "." + "paymentMethod")
			}
			return err
		}
	}
...
// ContextValidate validate this checkout guest payment information management v1 save payment information post body based on the context it is used
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostBody) contextValidateBillingAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationPostBody) contextValidatePaymentMethod(ctx context.Context, formats strfmt.Registry) error {
