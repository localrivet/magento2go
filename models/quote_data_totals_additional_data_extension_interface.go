		...
		if m.GiftMessages[i] != nil {
			if err := m.GiftMessages[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("gift_messages" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *QuoteDataTotalsAdditionalDataExtensionInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGiftMessages(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *QuoteDataTotalsAdditionalDataExtensionInterface) contextValidateGiftMessages(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.GiftMessages); i++ {

		if m.GiftMessages[i] != nil {
			if err := m.GiftMessages[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("gift_messages" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("gift_messages" + "." + strconv.Itoa(i))
