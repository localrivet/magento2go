...
// NewCatalogProductAttributeGroupRepositoryV1GetListGetParams creates a new CatalogProductAttributeGroupRepositoryV1GetListGetParams object,
...
func NewCatalogProductAttributeGroupRepositoryV1GetListGetParams() *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
	return &CatalogProductAttributeGroupRepositoryV1GetListGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCatalogProductAttributeGroupRepositoryV1GetListGetParamsWithTimeout creates a new CatalogProductAttributeGroupRepositoryV1GetListGetParams object
...
// NewCatalogProductAttributeGroupRepositoryV1GetListGetParamsWithContext creates a new CatalogProductAttributeGroupRepositoryV1GetListGetParams object
...
// NewCatalogProductAttributeGroupRepositoryV1GetListGetParamsWithHTTPClient creates a new CatalogProductAttributeGroupRepositoryV1GetListGetParams object
...
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WithDefaults() *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the catalog product attribute group repository v1 get list get params
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WithTimeout(timeout time.Duration) *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the catalog product attribute group repository v1 get list get params
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the catalog product attribute group repository v1 get list get params
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WithContext(ctx context.Context) *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the catalog product attribute group repository v1 get list get params
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the catalog product attribute group repository v1 get list get params
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WithHTTPClient(client *http.Client) *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the catalog product attribute group repository v1 get list get params
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WithSearchCriteriaCurrentPage(searchCriteriaCurrentPage *int64) *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
...
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WithSearchCriteriaPageSize(searchCriteriaPageSize *int64) *CatalogProductAttributeGroupRepositoryV1GetListGetParams {
...
func (o *CatalogProductAttributeGroupRepositoryV1GetListGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
