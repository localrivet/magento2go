...
func (o *IntegrationCustomerTokenServiceV1CreateCustomerAccessTokenPostOK) GetPayload() string {
	return o.Payload
}
...
func (o *IntegrationCustomerTokenServiceV1CreateCustomerAccessTokenPostBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *IntegrationCustomerTokenServiceV1CreateCustomerAccessTokenPostDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
// ContextValidate validates this integration customer token service v1 create customer access token post body based on context it is used
func (o *IntegrationCustomerTokenServiceV1CreateCustomerAccessTokenPostBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
