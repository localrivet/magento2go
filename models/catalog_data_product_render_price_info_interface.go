	...
	if m.FormattedPrices != nil {
		if err := m.FormattedPrices.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("formatted_prices")
			}
			return err
		}
	}
...
func (m *CatalogDataProductRenderPriceInfoInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateFormattedPrices(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CatalogDataProductRenderPriceInfoInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductRenderPriceInfoInterface) contextValidateFormattedPrices(ctx context.Context, formats strfmt.Registry) error {

	if m.FormattedPrices != nil {
		if err := m.FormattedPrices.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("formatted_prices")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("formatted_prices")
