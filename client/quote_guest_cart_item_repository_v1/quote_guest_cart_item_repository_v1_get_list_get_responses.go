...
func (o *QuoteGuestCartItemRepositoryV1GetListGetOK) GetPayload() []*models.QuoteDataCartItemInterface {
	return o.Payload
}
...
func (o *QuoteGuestCartItemRepositoryV1GetListGetBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *QuoteGuestCartItemRepositoryV1GetListGetDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
