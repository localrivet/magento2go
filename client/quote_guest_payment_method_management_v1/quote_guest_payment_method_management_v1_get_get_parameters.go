...
func (o *QuoteGuestPaymentMethodManagementV1GetGetParams) WithDefaults() *QuoteGuestPaymentMethodManagementV1GetGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *QuoteGuestPaymentMethodManagementV1GetGetParams) SetDefaults() {
