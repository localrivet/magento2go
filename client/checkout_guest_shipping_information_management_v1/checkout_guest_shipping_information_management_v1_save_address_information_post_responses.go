...
func (o *CheckoutGuestShippingInformationManagementV1SaveAddressInformationPostOK) GetPayload() *models.CheckoutDataPaymentDetailsInterface {
	return o.Payload
}
...
func (o *CheckoutGuestShippingInformationManagementV1SaveAddressInformationPostDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
	...
	if o.AddressInformation != nil {
		if err := o.AddressInformation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("checkoutGuestShippingInformationManagementV1SaveAddressInformationPostBody" + "." + "addressInformation")
			}
			return err
		}
	}
...
func (o *CheckoutGuestShippingInformationManagementV1SaveAddressInformationPostBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *CheckoutGuestShippingInformationManagementV1SaveAddressInformationPostBody) contextValidateAddressInformation(ctx context.Context, formats strfmt.Registry) error {
