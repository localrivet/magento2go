...
func (a *Client) PayPalBraintreeAuthV1GetGet(params *PayPalBraintreeAuthV1GetGetParams, opts ...ClientOption) (*PayPalBraintreeAuthV1GetGetOK, error) {
	...
	if params == nil {
		params = NewPayPalBraintreeAuthV1GetGetParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "payPalBraintreeAuthV1GetGet",
		Method:             "GET",
		PathPattern:        "/V1/applepay/auth",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PayPalBraintreeAuthV1GetGetReader{formats: a.formats},
	...
	success, ok := result.(*PayPalBraintreeAuthV1GetGetOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*PayPalBraintreeAuthV1GetGetDefault)
