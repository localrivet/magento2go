	...
	if o.Address != nil {
		if err := o.Address.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("quoteGuestShipmentEstimationV1EstimateByExtendedAddressPostBody" + "." + "address")
			}
			return err
		}
	}
...
func (o *QuoteGuestShipmentEstimationV1EstimateByExtendedAddressPostBody) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
