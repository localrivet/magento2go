...
func (o *DirectoryCountryInformationAcquirerV1GetCountriesInfoGetOK) GetPayload() []*models.DirectoryDataCountryInformationInterface {
	return o.Payload
}
...
func (o *DirectoryCountryInformationAcquirerV1GetCountriesInfoGetDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
