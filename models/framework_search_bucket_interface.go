...
func (m *FrameworkSearchBucketInterface) validateName(formats strfmt.Registry) error {
...
func (m *FrameworkSearchBucketInterface) validateValues(formats strfmt.Registry) error {
...
func (m *FrameworkSearchBucketInterface) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FrameworkSearchBucketInterface) UnmarshalBinary(b []byte) error {
	var res FrameworkSearchBucketInterface
