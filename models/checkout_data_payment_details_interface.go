		...
		if m.PaymentMethods[i] != nil {
			if err := m.PaymentMethods[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("payment_methods" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *CheckoutDataPaymentDetailsInterface) contextValidatePaymentMethods(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CheckoutDataPaymentDetailsInterface) contextValidateTotals(ctx context.Context, formats strfmt.Registry) error {
