	...
	if m.AddToCartButton != nil {
		if err := m.AddToCartButton.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("add_to_cart_button")
			}
			return err
		}
	}
	...
	if m.AddToCompareButton != nil {
		if err := m.AddToCompareButton.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("add_to_compare_button")
			}
			return err
		}
	}
	...
	if m.PriceInfo != nil {
		if err := m.PriceInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("price_info")
			}
			return err
		}
	}
...
func (m *CatalogDataProductRenderInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAddToCartButton(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateAddToCompareButton(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidatePriceInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CatalogDataProductRenderInterface) contextValidateAddToCartButton(ctx context.Context, formats strfmt.Registry) error {

	if m.AddToCartButton != nil {
		if err := m.AddToCartButton.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("add_to_cart_button")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("add_to_cart_button")
...
func (m *CatalogDataProductRenderInterface) contextValidateAddToCompareButton(ctx context.Context, formats strfmt.Registry) error {

	if m.AddToCompareButton != nil {
		if err := m.AddToCompareButton.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("add_to_compare_button")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("add_to_compare_button")
...
func (m *CatalogDataProductRenderInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductRenderInterface) contextValidateImages(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogDataProductRenderInterface) contextValidatePriceInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.PriceInfo != nil {
		if err := m.PriceInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("price_info")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("price_info")
