...
func (o *QuoteGuestCouponManagementV1SetPutReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewQuoteGuestCouponManagementV1SetPutOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewQuoteGuestCouponManagementV1SetPutBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	default:
		result := NewQuoteGuestCouponManagementV1SetPutDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewQuoteGuestCouponManagementV1SetPutOK() *QuoteGuestCouponManagementV1SetPutOK {
	return &QuoteGuestCouponManagementV1SetPutOK{}
}
...
func (o *QuoteGuestCouponManagementV1SetPutOK) Error() string {
	return fmt.Sprintf("[PUT /V1/guest-carts/{cartId}/coupons/{couponCode}][%d] quoteGuestCouponManagementV1SetPutOK  %+v", 200, o.Payload)
}
func (o *QuoteGuestCouponManagementV1SetPutOK) GetPayload() bool {
	return o.Payload
}

func (o *QuoteGuestCouponManagementV1SetPutOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQuoteGuestCouponManagementV1SetPutBadRequest() *QuoteGuestCouponManagementV1SetPutBadRequest {
	return &QuoteGuestCouponManagementV1SetPutBadRequest{}
}
...
func (o *QuoteGuestCouponManagementV1SetPutBadRequest) Error() string {
	return fmt.Sprintf("[PUT /V1/guest-carts/{cartId}/coupons/{couponCode}][%d] quoteGuestCouponManagementV1SetPutBadRequest  %+v", 400, o.Payload)
}
func (o *QuoteGuestCouponManagementV1SetPutBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *QuoteGuestCouponManagementV1SetPutBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewQuoteGuestCouponManagementV1SetPutDefault(code int) *QuoteGuestCouponManagementV1SetPutDefault {
	return &QuoteGuestCouponManagementV1SetPutDefault{
		_statusCode: code,
	}
}
...
func (o *QuoteGuestCouponManagementV1SetPutDefault) Error() string {
	return fmt.Sprintf("[PUT /V1/guest-carts/{cartId}/coupons/{couponCode}][%d] quoteGuestCouponManagementV1SetPut default  %+v", o._statusCode, o.Payload)
}
func (o *QuoteGuestCouponManagementV1SetPutDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *QuoteGuestCouponManagementV1SetPutDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
