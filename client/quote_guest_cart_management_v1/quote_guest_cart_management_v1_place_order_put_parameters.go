...
func (o *QuoteGuestCartManagementV1PlaceOrderPutParams) WithDefaults() *QuoteGuestCartManagementV1PlaceOrderPutParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *QuoteGuestCartManagementV1PlaceOrderPutParams) SetDefaults() {
