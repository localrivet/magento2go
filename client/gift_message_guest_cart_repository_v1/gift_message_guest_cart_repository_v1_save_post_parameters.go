...
/* GiftMessageGuestCartRepositoryV1SavePostParams contains all the parameters to send to the API endpoint
   for the gift message guest cart repository v1 save post operation.
...
// WithDefaults hydrates default values in the gift message guest cart repository v1 save post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GiftMessageGuestCartRepositoryV1SavePostParams) WithDefaults() *GiftMessageGuestCartRepositoryV1SavePostParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the gift message guest cart repository v1 save post params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GiftMessageGuestCartRepositoryV1SavePostParams) SetDefaults() {
