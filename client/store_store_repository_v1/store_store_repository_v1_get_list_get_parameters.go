...
/* StoreStoreRepositoryV1GetListGetParams contains all the parameters to send to the API endpoint
   for the store store repository v1 get list get operation.
...
// WithDefaults hydrates default values in the store store repository v1 get list get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StoreStoreRepositoryV1GetListGetParams) WithDefaults() *StoreStoreRepositoryV1GetListGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the store store repository v1 get list get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StoreStoreRepositoryV1GetListGetParams) SetDefaults() {
