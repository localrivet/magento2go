...
// WithDefaults hydrates default values in the store store config manager v1 get store configs get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StoreStoreConfigManagerV1GetStoreConfigsGetParams) WithDefaults() *StoreStoreConfigManagerV1GetStoreConfigsGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the store store config manager v1 get store configs get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StoreStoreConfigManagerV1GetStoreConfigsGetParams) SetDefaults() {
...
func (o *StoreStoreConfigManagerV1GetStoreConfigsGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.StoreCodes != nil {
		...
		// binding items for storeCodes
		joinedStoreCodes := o.bindParamStoreCodes(reg)
...
// bindParamStoreStoreConfigManagerV1GetStoreConfigsGet binds the parameter storeCodes
func (o *StoreStoreConfigManagerV1GetStoreConfigsGetParams) bindParamStoreCodes(formats strfmt.Registry) []string {
	storeCodesIR := o.StoreCodes

	var storeCodesIC []string
	for _, storeCodesIIR := range storeCodesIR { // explode []string

		storeCodesIIV := storeCodesIIR // string as string
		storeCodesIC = append(storeCodesIC, storeCodesIIV)
	}

	// items.CollectionFormat: ""
	storeCodesIS := swag.JoinByFormat(storeCodesIC, "")
