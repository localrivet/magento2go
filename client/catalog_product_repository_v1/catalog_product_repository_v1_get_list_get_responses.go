...
func (o *CatalogProductRepositoryV1GetListGetOK) GetPayload() *models.CatalogDataProductSearchResultsInterface {
	return o.Payload
}
...
func (o *CatalogProductRepositoryV1GetListGetDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
