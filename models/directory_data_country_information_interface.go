		...
		if m.AvailableRegions[i] != nil {
			if err := m.AvailableRegions[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("available_regions" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *DirectoryDataCountryInformationInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAvailableRegions(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DirectoryDataCountryInformationInterface) contextValidateAvailableRegions(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.AvailableRegions); i++ {

		if m.AvailableRegions[i] != nil {
			if err := m.AvailableRegions[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("available_regions" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("available_regions" + "." + strconv.Itoa(i))
