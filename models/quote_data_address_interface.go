...
func (m *QuoteDataAddressInterface) contextValidateCustomAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuoteDataAddressInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
