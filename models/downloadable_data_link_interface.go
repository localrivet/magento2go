	...
	if m.LinkFileContent != nil {
		if err := m.LinkFileContent.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("link_file_content")
			}
			return err
		}
	}
	...
	if m.SampleFileContent != nil {
		if err := m.SampleFileContent.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("sample_file_content")
			}
			return err
		}
	}
...
func (m *DownloadableDataLinkInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateLinkFileContent(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSampleFileContent(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DownloadableDataLinkInterface) contextValidateLinkFileContent(ctx context.Context, formats strfmt.Registry) error {

	if m.LinkFileContent != nil {
		if err := m.LinkFileContent.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("link_file_content")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("link_file_content")
...
func (m *DownloadableDataLinkInterface) contextValidateSampleFileContent(ctx context.Context, formats strfmt.Registry) error {

	if m.SampleFileContent != nil {
		if err := m.SampleFileContent.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sample_file_content")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sample_file_content")
