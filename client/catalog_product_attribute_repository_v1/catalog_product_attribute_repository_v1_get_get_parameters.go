...
// NewCatalogProductAttributeRepositoryV1GetGetParams creates a new CatalogProductAttributeRepositoryV1GetGetParams object,
...
func NewCatalogProductAttributeRepositoryV1GetGetParams() *CatalogProductAttributeRepositoryV1GetGetParams {
	return &CatalogProductAttributeRepositoryV1GetGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCatalogProductAttributeRepositoryV1GetGetParamsWithTimeout creates a new CatalogProductAttributeRepositoryV1GetGetParams object
...
// NewCatalogProductAttributeRepositoryV1GetGetParamsWithContext creates a new CatalogProductAttributeRepositoryV1GetGetParams object
...
// NewCatalogProductAttributeRepositoryV1GetGetParamsWithHTTPClient creates a new CatalogProductAttributeRepositoryV1GetGetParams object
...
/* CatalogProductAttributeRepositoryV1GetGetParams contains all the parameters to send to the API endpoint
   for the catalog product attribute repository v1 get get operation.

   Typically these are written to a http.Request.
*/
type CatalogProductAttributeRepositoryV1GetGetParams struct {
