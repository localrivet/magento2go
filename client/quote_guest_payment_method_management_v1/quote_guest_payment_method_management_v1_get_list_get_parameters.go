...
func (o *QuoteGuestPaymentMethodManagementV1GetListGetParams) WithDefaults() *QuoteGuestPaymentMethodManagementV1GetListGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *QuoteGuestPaymentMethodManagementV1GetListGetParams) SetDefaults() {
