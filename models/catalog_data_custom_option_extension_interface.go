	...
	if m.FileInfo != nil {
		if err := m.FileInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("file_info")
			}
			return err
		}
	}
...
func (m *CatalogDataCustomOptionExtensionInterface) contextValidateFileInfo(ctx context.Context, formats strfmt.Registry) error {
