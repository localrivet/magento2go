...
func (o *QuoteGuestCartItemRepositoryV1GetListGetParams) WithDefaults() *QuoteGuestCartItemRepositoryV1GetListGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *QuoteGuestCartItemRepositoryV1GetListGetParams) SetDefaults() {
