...
func (o *CatalogInventoryStockRegistryV1GetStockStatusBySkuGetParams) WithDefaults() *CatalogInventoryStockRegistryV1GetStockStatusBySkuGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CatalogInventoryStockRegistryV1GetStockStatusBySkuGetParams) SetDefaults() {
