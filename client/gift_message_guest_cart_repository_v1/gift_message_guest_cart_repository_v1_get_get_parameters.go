...
/* GiftMessageGuestCartRepositoryV1GetGetParams contains all the parameters to send to the API endpoint
   for the gift message guest cart repository v1 get get operation.
...
// WithDefaults hydrates default values in the gift message guest cart repository v1 get get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GiftMessageGuestCartRepositoryV1GetGetParams) WithDefaults() *GiftMessageGuestCartRepositoryV1GetGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the gift message guest cart repository v1 get get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GiftMessageGuestCartRepositoryV1GetGetParams) SetDefaults() {
