		...
		if m.ChildrenData[i] != nil {
			if err := m.ChildrenData[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("children_data" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *CatalogDataCategoryTreeInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateChildrenData(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CatalogDataCategoryTreeInterface) contextValidateChildrenData(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ChildrenData); i++ {

		if m.ChildrenData[i] != nil {
			if err := m.ChildrenData[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("children_data" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("children_data" + "." + strconv.Itoa(i))
