	...
	if m.ProductOption != nil {
		if err := m.ProductOption.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("product_option")
			}
			return err
		}
	}
...
func (m *QuoteDataCartItemInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateProductOption(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *QuoteDataCartItemInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuoteDataCartItemInterface) contextValidateProductOption(ctx context.Context, formats strfmt.Registry) error {

	if m.ProductOption != nil {
		if err := m.ProductOption.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("product_option")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("product_option")
