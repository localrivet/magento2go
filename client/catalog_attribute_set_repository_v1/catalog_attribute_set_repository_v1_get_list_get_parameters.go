...
// NewCatalogAttributeSetRepositoryV1GetListGetParams creates a new CatalogAttributeSetRepositoryV1GetListGetParams object,
...
func NewCatalogAttributeSetRepositoryV1GetListGetParams() *CatalogAttributeSetRepositoryV1GetListGetParams {
	return &CatalogAttributeSetRepositoryV1GetListGetParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCatalogAttributeSetRepositoryV1GetListGetParamsWithTimeout creates a new CatalogAttributeSetRepositoryV1GetListGetParams object
...
// NewCatalogAttributeSetRepositoryV1GetListGetParamsWithContext creates a new CatalogAttributeSetRepositoryV1GetListGetParams object
...
// NewCatalogAttributeSetRepositoryV1GetListGetParamsWithHTTPClient creates a new CatalogAttributeSetRepositoryV1GetListGetParams object
...
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) WithDefaults() *CatalogAttributeSetRepositoryV1GetListGetParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the catalog attribute set repository v1 get list get params
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) WithTimeout(timeout time.Duration) *CatalogAttributeSetRepositoryV1GetListGetParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the catalog attribute set repository v1 get list get params
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the catalog attribute set repository v1 get list get params
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) WithContext(ctx context.Context) *CatalogAttributeSetRepositoryV1GetListGetParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the catalog attribute set repository v1 get list get params
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the catalog attribute set repository v1 get list get params
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) WithHTTPClient(client *http.Client) *CatalogAttributeSetRepositoryV1GetListGetParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the catalog attribute set repository v1 get list get params
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
func (o *CatalogAttributeSetRepositoryV1GetListGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
