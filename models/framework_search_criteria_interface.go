...
func (m *FrameworkSearchCriteriaInterface) contextValidateFilterGroups(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FrameworkSearchCriteriaInterface) contextValidateSortOrders(ctx context.Context, formats strfmt.Registry) error {
