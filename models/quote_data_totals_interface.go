		...
		if m.TotalSegments[i] != nil {
			if err := m.TotalSegments[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("total_segments" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *QuoteDataTotalsInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTotalSegments(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *QuoteDataTotalsInterface) contextValidateExtensionAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuoteDataTotalsInterface) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *QuoteDataTotalsInterface) contextValidateTotalSegments(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.TotalSegments); i++ {

		if m.TotalSegments[i] != nil {
			if err := m.TotalSegments[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("total_segments" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("total_segments" + "." + strconv.Itoa(i))
