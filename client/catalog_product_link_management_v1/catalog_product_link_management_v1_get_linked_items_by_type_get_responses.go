...
func (o *CatalogProductLinkManagementV1GetLinkedItemsByTypeGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewCatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest() *CatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest {
	return &CatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest{}
}
...
func (o *CatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest) Error() string {
	return fmt.Sprintf("[GET /V1/products/{sku}/links/{type}][%d] catalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest  %+v", 400, o.Payload)
}
func (o *CatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}

func (o *CatalogProductLinkManagementV1GetLinkedItemsByTypeGetBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
