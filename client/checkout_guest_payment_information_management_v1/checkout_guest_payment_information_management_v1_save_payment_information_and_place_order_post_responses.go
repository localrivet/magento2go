...
/* CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostOK describes a response with status code 200, with default header values.
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostOK) GetPayload() int64 {
	return o.Payload
}
...
/* CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBadRequest describes a response with status code 400, with default header values.
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
/* CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostDefault describes a response with status code -1, with default header values.
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostDefault) GetPayload() *models.ErrorResponse {
	return o.Payload
}
	...
	if o.BillingAddress != nil {
		if err := o.BillingAddress.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody" + "." + "billingAddress")
			}
			return err
		}
	}
	...
	if o.PaymentMethod != nil {
		if err := o.PaymentMethod.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody" + "." + "paymentMethod")
			}
			return err
		}
	}
...
// ContextValidate validate this checkout guest payment information management v1 save payment information and place order post body based on the context it is used
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := o.contextValidateBillingAddress(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody) contextValidateBillingAddress(ctx context.Context, formats strfmt.Registry) error {

	if o.BillingAddress != nil {
		if err := o.BillingAddress.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody" + "." + "billingAddress")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("checkoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody" + "." + "billingAddress")
...
func (o *CheckoutGuestPaymentInformationManagementV1SavePaymentInformationAndPlaceOrderPostBody) contextValidatePaymentMethod(ctx context.Context, formats strfmt.Registry) error {
